  ...
  const servicios = [
    {
      ...
      icon: '📊',
      color: '#1E40AF',
      // Reemplaza esto con tu imagen: imagen: 'URL_DE_LA_IMAGEN_O_PATH'
    },
    {
          ...
          {servicios.map((servicio, index) => (
            ...
            >
              ...
              <div
                style={{
                  backgroundColor: servicio.color,
                  height: hoveredIndex === index ? '80px' : isMobile ? '200px' : '220px',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  fontSize: hoveredIndex === index ? '24px' : '56px',
              ...
              >
                ...
                {/* Descripción - APARECE AL HOVER O SIEMPRE EN MÓVIL */}
                {hoveredIndex === index && (
                  <p
                    style={{
                      color: 'white',

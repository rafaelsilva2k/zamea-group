        ...
        >
          ...
          <div>
            ...
            >
              ...
              >
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#1f326f' }}>
                  300+
                </div>
              ...
              >
                <div style={{ fontSize: '28px', fontWeight: 'bold', color: '#4DD9A6' }}>
                  2+ Años
                </div>
                <div style={{ color: '#666', marginTop: '8px', fontSize: '14px' }}>
                  De Experiencia
          ...
          >
            ...
            <div
              ...
              onMouseOver={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 15px 40px rgba(30, 64, 175, 0.3)';
              }}
              onMouseOut={(e) => {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = '0 10px 30px rgba(30, 64, 175, 0.2)';
              }}
            >
            ...
            <div
              ...
              onMouseOver={(e) => {
                e.currentTarget.style.transform = 'translateY(-5px)';
                e.currentTarget.style.boxShadow = '0 15px 40px rgba(77, 217, 166, 0.3)';
              }}
              onMouseOut={(e) => {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = '0 10px 30px rgba(77, 217, 166, 0.2)';
              }}
            >
              <div style={{ fontSize: '40px', marginBottom: '12px' }}>💼</div>
              <h3 style={{ margin: '0 0 12px 0', fontSize: '20px', fontWeight: 'bold' }}>

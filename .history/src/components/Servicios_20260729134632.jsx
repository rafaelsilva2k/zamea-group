...
function Servicios() {
  ...
  const servicios = [
    ...
    {
      titulo: 'Modalidad 10',
      descripcion: '¿Conoces la Modalidad 10? ¿Sabes todos los beneficios que puede ofrecerte?
Agenda una asesoría presencial gratuita y descubre si esta opción es la más conveniente para ti. Nuestros especialistas analizarán tu caso y resolverán todas tus dudas.',
      icon: '🎯',
      color: '#63ab32',
